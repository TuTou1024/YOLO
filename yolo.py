...
weightsPath = "F:/OpenCV/Pytorch/yolo-nwp_final.weights"  # 权重文件
configPath = "D:/2017/Project1/demo/yolov3.txt"  # 配置文件
labelsPath = "D:/2017/Project1/demo/coconames.txt"  # label名称
imgPath = "F:/OpenCV/Pytorch/yaogan/Pytorch-Yolov3---Remote-sensing-image-master/data/owndata/29.jpg"  # 测试图像F:/OpenCV/Pytorch/yaogan/Pytorch-Yolov3---Remote-sensing-image-master/data/owndata/29.jpg
CONFIDENCE = 0.5  # 过滤弱检测的最小概率
THRESHOLD = 0.4  # 非最大值抑制阈值


# 加载网络、配置权重
net = cv.dnn.readNetFromTorch(weightsPath,1)  # #  利用下载的文件
print("[INFO] 加载网络，配置权重成功！")  # # 可以打印下信息



# 加载图片、转为blob格式、送入网络输入层
img = cv.imread(imgPath)
blobImg = cv.dnn.blobFromImage(img, 1.0/255.0, (416, 416), None, True, False)   # # 用blobFromImage这个函数来转格式
...
print("[INFO] YOLO 耗时 {:.6f} seconds".format(end - start))  # # 可以打印下信息
